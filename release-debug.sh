...
# compile
#gcc -c z64snd.c -Wall -g -Og -DZ64AUDIO_EXTERNAL_DEPENDENCIES -Iwowlib -DWOW_OVERLOAD_FILE -Wno-format-truncation
gcc -c z64snd.c -Wall -g -Og -Iwowlib -DWOW_OVERLOAD_FILE -Wno-format-truncation
