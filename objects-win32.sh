...
~/c/mxe/usr/bin/i686-w64-mingw32.static-g++ -std=c++11 -c -Os -DNDEBUG tools/audiofile/audiofile.cpp -Itools/audiofile

# compile C objects using gcc
~/c/mxe/usr/bin/i686-w64-mingw32.static-gcc -c tools/sdk-tools/tabledesign/*.c -s -Os -flto -DNDEBUG -Itools/audiofile
